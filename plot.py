...
def quick_plot(input_filename=None, data_filename=None, movie_filename=None):
    ...
    for i in range(len(D_2d[:,0,0,0])):
        outname = '../../Documents/Work/swerve/plotting/swirly3_' + format(i, '05') + '.png'
        ax.clear()
        ax.set_xlim(0,10)
        ax.set_ylim(0,10)
        ax.set_zlim(0.7,1.4)
...
if __name__ == '__main__':
    #plotme()
    quick_plot(data_filename="../../Documents/Work/swerve/swirly3.h5", movie_filename="../../Documents/Work/swerve/tsunami_long.mp4")
